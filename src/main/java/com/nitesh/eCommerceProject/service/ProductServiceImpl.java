...
import com.nitesh.eCommerceProject.exception.CategoryNotFoundException;
import com.nitesh.eCommerceProject.exception.ProductNotFoundException;
import com.nitesh.eCommerceProject.repository.ProductDao;
		...
		Product prod = null;
		 ...
		 if(opt!=null) {
			 ...
			 if(prod.getQuantity()>0) {
				 prod.setStatus(ProductStatusEnum.AVAILABLE);
			 }
			 prodDao.save(prod);
